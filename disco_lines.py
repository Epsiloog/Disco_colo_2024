...
try:
    while True:
        ...
        # Déterminer la couleur et la longueur en fonction de la fréquence et de l'intensité
        couleur = (int(min(255, freq_dominante / 2)), int(min(255, intensite / 1000)), 0)
        longueur = int(min(400, intensite / 100))

        # Dessiner une ligne
        screen.fill((255, 255, 255))  # Effacer l'écran
        pygame.draw.line(screen, couleur, (400, 300), (400 + longueur, 300), 5)
